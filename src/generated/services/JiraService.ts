...
export class JiraService {
  ...
  public static async EditIssue_V2(X_Request_Jirainstance: string, issueIdOrKey: string, notifyUsers?: boolean, overrideScreenSecurity?: boolean, overrideEditableFlag?: boolean, body?: Record<string, unknown>): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, issueIdOrKey: string, notifyUsers?: boolean, overrideScreenSecurity?: boolean, overrideEditableFlag?: boolean, body?: Record<string, unknown> } = { "X-Request-Jirainstance": X_Request_Jirainstance, issueIdOrKey, notifyUsers, overrideScreenSecurity, overrideEditableFlag, body };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, issueIdOrKey: string, notifyUsers?: boolean, overrideScreenSecurity?: boolean, overrideEditableFlag?: boolean, body?: Record<string, unknown> }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async DeleteProject_V2(X_Request_Jirainstance: string, projectIdOrKey: string, enableUndo?: boolean): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, projectIdOrKey: string, enableUndo?: boolean } = { "X-Request-Jirainstance": X_Request_Jirainstance, projectIdOrKey, enableUndo };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, projectIdOrKey: string, enableUndo?: boolean }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async UpdateProject_V2(X_Request_Jirainstance: string, projectIdOrKey: string, body?: Record<string, unknown>): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, projectIdOrKey: string, body?: Record<string, unknown> } = { "X-Request-Jirainstance": X_Request_Jirainstance, projectIdOrKey, body };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, projectIdOrKey: string, body?: Record<string, unknown> }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async GetAllProjectCategories_V2(X_Request_Jirainstance: string): Promise<IOperationResult<unknown>> {
    const params: { "X-Request-Jirainstance": string } = { "X-Request-Jirainstance": X_Request_Jirainstance };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string }, unknown>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async CreateProjectCategory_V2(X_Request_Jirainstance: string, body?: Record<string, unknown>): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, body?: Record<string, unknown> } = { "X-Request-Jirainstance": X_Request_Jirainstance, body };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, body?: Record<string, unknown> }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async RemoveProjectCategory_V2(X_Request_Jirainstance: string, id: number): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, id: number } = { "X-Request-Jirainstance": X_Request_Jirainstance, id };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, id: number }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async GetTask_V2(X_Request_Jirainstance: string, taskId: string): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, taskId: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, taskId };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, taskId: string }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async CancelTask(taskId: string, X_Atlassian_Token: string): Promise<IOperationResult<void>> {
    const params: { taskId: string, "X-Atlassian-Token": string } = { taskId, "X-Atlassian-Token": X_Atlassian_Token };
    const result = await JiraService.client.executeAsync<{ taskId: string, "X-Atlassian-Token": string }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async CancelTask_V2(X_Request_Jirainstance: string, taskId: string, X_Atlassian_Token: string): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, taskId: string, "X-Atlassian-Token": string } = { "X-Request-Jirainstance": X_Request_Jirainstance, taskId, "X-Atlassian-Token": X_Atlassian_Token };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, taskId: string, "X-Atlassian-Token": string }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async GetUser_V2(X_Request_Jirainstance: string, accountId: string, expand?: string): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, accountId: string, expand?: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, accountId, expand };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, accountId: string, expand?: string }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async CreateIssue_V3(X_Request_Jirainstance: string, projectKey: string, issueTypeIds: string, item?: Record<string, unknown>): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, projectKey: string, issueTypeIds: string, item?: Record<string, unknown> } = { "X-Request-Jirainstance": X_Request_Jirainstance, projectKey, issueTypeIds, item };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, projectKey: string, issueTypeIds: string, item?: Record<string, unknown> }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async GetIssue_V2(X_Request_Jirainstance: string, issueKey: string): Promise<IOperationResult<FullIssue>> {
    const params: { "X-Request-Jirainstance": string, issueKey: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, issueKey };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, issueKey: string }, FullIssue>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async AddComment_V2(X_Request_Jirainstance: string, issueKey: string, body: Comment): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, issueKey: string, body: Comment } = { "X-Request-Jirainstance": X_Request_Jirainstance, issueKey, body };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, issueKey: string, body: Comment }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async CreateProject_V2(X_Request_Jirainstance: string, Project: Record<string, unknown>): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, Project: Record<string, unknown> } = { "X-Request-Jirainstance": X_Request_Jirainstance, Project };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, Project: Record<string, unknown> }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListProjects_V3(X_Request_Jirainstance: string): Promise<IOperationResult<ListProjects_ResponseV2>> {
    const params: { "X-Request-Jirainstance": string } = { "X-Request-Jirainstance": X_Request_Jirainstance };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string }, ListProjects_ResponseV2>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListProjectUsers_V2(X_Request_Jirainstance: string, projectKey: string): Promise<IOperationResult<UserList>> {
    const params: { "X-Request-Jirainstance": string, projectKey: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, projectKey };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, projectKey: string }, UserList>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListFilters_V2(X_Request_Jirainstance: string): Promise<IOperationResult<ListFiltersResponse>> {
    const params: { "X-Request-Jirainstance": string } = { "X-Request-Jirainstance": X_Request_Jirainstance };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string }, ListFiltersResponse>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
   ...
   */
  public static async ListIssues(X_Request_Jirainstance: string, jql?: string, expand?: string, fields?: string, nextPageToken?: string): Promise<IOperationResult<ListIssuesResponse>> {
    const params: { "X-Request-Jirainstance": string, jql?: string, expand?: string, fields?: string, nextPageToken?: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, jql, expand, fields, nextPageToken };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, jql?: string, expand?: string, fields?: string, nextPageToken?: string }, ListIssuesResponse>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListIssues_Datacenter(X_Request_Jirainstance: string): Promise<IOperationResult<ListIssuesResponseDatacenter>> {
    const params: { "X-Request-Jirainstance": string } = { "X-Request-Jirainstance": X_Request_Jirainstance };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string }, ListIssuesResponseDatacenter>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async ListTransitions(X_Request_Jirainstance: string, issueIdOrKey: string): Promise<IOperationResult<Record<string, unknown>>> {
    const params: { "X-Request-Jirainstance": string, issueIdOrKey: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, issueIdOrKey };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, issueIdOrKey: string }, Record<string, unknown>>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async UpdateTransition(X_Request_Jirainstance: string, issueIdOrKey: string, body: TransitionInput): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, issueIdOrKey: string, body: TransitionInput } = { "X-Request-Jirainstance": X_Request_Jirainstance, issueIdOrKey, body };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, issueIdOrKey: string, body: TransitionInput }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async GetCurrentUser(X_Request_Jirainstance: string, expand?: string): Promise<IOperationResult<void>> {
    const params: { "X-Request-Jirainstance": string, expand?: string } = { "X-Request-Jirainstance": X_Request_Jirainstance, expand };
    const result = await JiraService.client.executeAsync<{ "X-Request-Jirainstance": string, expand?: string }, void>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async OnNewIssue_V2(projectKey: string, X_Request_Jirainstance?: string): Promise<IOperationResult<FullIssue[]>> {
    const params: { projectKey: string, "X-Request-Jirainstance"?: string } = { projectKey, "X-Request-Jirainstance": X_Request_Jirainstance };
    const result = await JiraService.client.executeAsync<{ projectKey: string, "X-Request-Jirainstance"?: string }, FullIssue[]>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
  ...
  public static async OnNewIssueJQL_V2(jql: string, X_Request_Jirainstance?: string): Promise<IOperationResult<FullIssue[]>> {
    const params: { jql: string, "X-Request-Jirainstance"?: string } = { jql, "X-Request-Jirainstance": X_Request_Jirainstance };
    const result = await JiraService.client.executeAsync<{ jql: string, "X-Request-Jirainstance"?: string }, FullIssue[]>(
      {
        connectorOperation: {
          tableName: JiraService.dataSourceName,
